...
parser.add_argument('--batch_size', type=int, default=2, help='the number of HSIs per batch')  #dehaust
...
parser.add_argument("--store_psnr", type=float, default=19)
